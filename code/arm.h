...
float forearm_I = 81.0f*2000; //the rotational inertia of the forearm
float forearm_m = 2000.0f;
...
float spring_force = 2802000;

float k_string = 43340000;
...
float neverest_k_i = dc_motor_voltage/13.51;
float neverest_k_t_over_R = neverest_max_torque/dc_motor_voltage;

float string_length_0 = 33.0;
